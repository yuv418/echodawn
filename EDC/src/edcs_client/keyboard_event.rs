...
pub fn virtual_key_code_to_linux_input(vkc: VirtualKeyCode) -> i32 {
    match vkc {
        VirtualKeyCode::Key1 => KEY_NUMERIC_1,
        VirtualKeyCode::Key2 => KEY_NUMERIC_2,
        VirtualKeyCode::Key3 => KEY_NUMERIC_3,
        VirtualKeyCode::Key4 => KEY_NUMERIC_4,
        VirtualKeyCode::Key5 => KEY_NUMERIC_5,
        VirtualKeyCode::Key6 => KEY_NUMERIC_6,
        VirtualKeyCode::Key7 => KEY_NUMERIC_7,
        VirtualKeyCode::Key8 => KEY_NUMERIC_8,
        VirtualKeyCode::Key9 => KEY_NUMERIC_9,
        VirtualKeyCode::Key0 => KEY_NUMERIC_0,
